...
public interface IEmailService
{
    ...
    Task<bool> SendMessageToAdministratorAsync(string subject, string bodyHtml);
    ...
    Task<bool> SendMessageToAdministratorAsync(IEnumerable<string> ccAddressList, string subject, string bodyHtml);
    ...
    /// <param name="subject">The message subject</param>
    /// <param name="bodyHtml">The message body</param>
    Task<bool> SendMessageAsync(string toAddress, string subject, string bodyHtml);
    ...
    /// <param name="subject">The message subject</param>
    /// <param name="bodyHtml">The message body</param>
    Task<bool> SendMessageAsync(string toAddress, IEnumerable<string> ccAddressList, string subject, string bodyHtml);
    ...
    /// <param name="subject">The message subject</param>
    /// <param name="bodyHtml">The message body</param>
    Task<bool> SendWithReplyToAsync(string replyToAddress, string replyToName, string toAddress, string subject,
        string bodyHtml);
    ...
    /// <param name="subject">The message subject</param>
    /// <param name="bodyHtml">The message body</param>
    Task<bool> SendWithReplyToAsync(string replyToAddress, string replyToName, string toAddress,
    ...
    /// <param name="subject">The message subject</param>
    /// <param name="bodyHtml">The message body</param>
    Task<bool> SendWithCustomFromEmailAsync(string fromAddress, string fromName, string toAddress, string subject,
        string bodyHtml);
    ...
    /// <summary>
    ///     Sends a message to the specified recipient, and CC's with the supplied subject and body using a custom from address
    /// </summary>
    /// <param name="fromAddress">The address to be used as the sender</param>
    /// <param name="fromName">The name to be used as the sender</param>
    /// <param name="toAddress">Who is receiving the email</param>
